...
const orbitImages: OrbitImage[] = [
  {
    src: "/images/orbit/orbit-1.webp",
    alt: "Mithra outdoors on a hillside under a clear blue sky.",
  },
  {
    src: "/images/orbit/orbit-2.webp",
    alt: "Mithra sitting by a lily pond beside a wooden cart pavilion.",
  },
  {
    src: "/images/orbit/orbit-3.webp",
    alt: "Mithra taking a mirror photo in a lift.",
  },
  {
    src: "/images/orbit/orbit-4.webp",
    alt: "Mithra at a table in a taqueria, black and white.",
  },
  {
    src: "/images/orbit/orbit-5.webp",
    alt: "Mithra reading a paperback at a wooden café table.",
  },
];
  ...
  return (
    ...
    <div className="flex w-full flex-col items-center gap-16 p-6 lg:p-10">
      <Reveal className="flex w-full max-w-[1800px] flex-col gap-40 lg:gap-60">
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between lg:gap-10">
              ...
              The 1200px stop is the h1's own, not a Tailwind default. */}
                <p
                  ...
                  style={{
                    fontSize: "clamp(0.927rem, 0.18rem + 2.643vw, 2.163rem)",
                  }}
                >
                  {profile.name}
                </p>
        ...
        {/* Services and Tools as one band, half the measure each: what she
            takes on, beside what she takes it on with. They answer the same
            question from two directions, and stacked they read as two
            separate claims with a scroll between them.

            Twelve columns rather than two, so the split is stated as 6 and 6
            and can be re-weighted later without changing the structure. */}
        <div className="grid w-full grid-cols-1 gap-x-16 gap-y-16 lg:grid-cols-12">
